...
public class FindFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query showAllUsersQuery = allUsersDatabaseRef.orderByChild("fullname");
        FirebaseRecyclerAdapter<FindFriends, FindFriendsViewHolder> listAllAdapter
        ...
        SearchResultList.setAdapter(listAllAdapter);
